...
export const topics: Topic[] = [
  {
    ...
    title: "Topics.gettingStarted.about1Market.title",
    image: "/getting-started/1.png",
    description: "Topics.gettingStarted.about1Market.description",
    ...
    sections: [
      {
        id: "introduction",
        title: "Topics.gettingStarted.about1Market.sections.introduction.title",
        content:
          "Topics.gettingStarted.about1Market.sections.introduction.content",
      },
      {
        id: "missionVision",
        title:
          "Topics.gettingStarted.about1Market.sections.missionVision.title",
        content:
          "Topics.gettingStarted.about1Market.sections.missionVision.content",
      },
      {
        id: "strengths",
        title: "Topics.gettingStarted.about1Market.sections.strengths.title",
        content:
          "Topics.gettingStarted.about1Market.sections.strengths.content",
      },
      {
        id: "coreValues",
        title: "Topics.gettingStarted.about1Market.sections.coreValues.title",
        content:
          "Topics.gettingStarted.about1Market.sections.coreValues.content",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        <ul>
          <li>Go to <strong>seller.1market.ph/register</strong> using any browser on your phone, tablet, or computer.</li>
    ...
    sections: [
      {
        ...
        content: `
          ...
          <ul>
            ...
            <li>Shipping preparation: 1-3 business days</li>
            <li>Tracking information: Within 24 hours of dispatch</li>
          </ul>
      ...
      },
      {
        ...
        content: `
          <p>Proper shipping practices ensure timely delivery and customer satisfaction.</p>
          <h4>Packaging Requirements:</h4>
          <ul>
            <li><strong>Protection:</strong> Use appropriate cushioning materials</li>
            <li><strong>Size:</strong> Use smallest box that safely fits the item</li>
            <li><strong>Sealing:</strong> Secure all openings with quality tape</li>
            <li><strong>Labeling:</strong> Clear, legible shipping labels</li>
            <li><strong>Branding:</strong> Include business cards or branded materials</li>
          </ul>
          <h4>Shipping Options:</h4>
          <ul>
            <li><strong>Standard Shipping:</strong> 3-7 business days, most economical</li>
            <li><strong>Express Shipping:</strong> 1-3 business days, premium pricing</li>
            <li><strong>Same-Day Delivery:</strong> Available in Metro Manila</li>
            <li><strong>Cash on Delivery:</strong> Payment upon delivery option</li>
          </ul>
          <h4>Packaging Best Practices:</h4>
          <ul>
            <li>Use bubble wrap for fragile items</li>
            <li>Fill empty spaces to prevent movement</li>
            <li>Double-box valuable or fragile items</li>
            <li>Include packing slip and receipt</li>
      ...
      },
      {
        ...
        title: "Shipping Partners and Logistics",
        content: `
          <p>Choose the right shipping partners for your business needs.</p>
          <h4>Integrated Shipping Partners:</h4>
          <ul>
            <li><strong>LBC:</strong> Nationwide coverage, reliable service</li>
            <li><strong>J&T Express:</strong> Fast delivery, competitive rates</li>
            <li><strong>Ninja Van:</strong> Technology-driven logistics</li>
            <li><strong>2GO Express:</strong> Island-to-island shipping</li>
            <li><strong>Philippine Post:</strong> Government postal service</li>
          </ul>
          <h4>Choosing the Right Partner:</h4>
          <ul>
            <li>Coverage area and delivery speed</li>
            <li>Shipping rates and fees</li>
            <li>Package size and weight limits</li>
  ...
  },
  {
    ...
    description:
      "Expand your business globally with international selling strategies.",
    category: "Advanced Topics",
    readTime: "25 min read",
    difficulty: "Advanced",
    tags: ["international", "global", "export"],
    sections: [
      {
        id: "global-expansion",
        title: "Global Market Expansion",
        content: `
          <p>Learn how to expand your business to international markets.</p>
          <h4>Market Selection Criteria:</h4>
          <ul>
            <li>Market size and growth potential</li>
            <li>Regulatory environment and barriers</li>
            <li>Cultural compatibility and preferences</li>
            <li>Logistics and shipping feasibility</li>
            <li>Competition level and market saturation</li>
          </ul>
          <h4>International Shipping Considerations:</h4>
          <ul>
            <li>Customs documentation and procedures</li>
            <li>International shipping costs and timeframes</li>
            <li>Import duties and taxes</li>
            <li>Restricted and prohibited items by country</li>
          </ul>
        `,
      },
      {
        ...
        content: `
          <p>Ensure compliance with international trade regulations.</p>
          <h4>Documentation Requirements:</h4>
          <ul>
            <li>Commercial invoices</li>
            <li>Packing lists</li>
            <li>Certificates of origin</li>
            <li>Export permits (if required)</li>
          </ul>
          <h4>Regulatory Compliance:</h4>
          <ul>
            <li>Product safety standards by country</li>
            <li>Labeling and packaging requirements</li>
            <li>Import/export restrictions</li>
            <li>Tax obligations in destination countries</li>
          </ul>
        `,
      },
    ],
...
export function getAllCategories(t: any): string[] {
  const uniqueCategories = [...new Set(topics.map((topic) => topic.category))];
  return uniqueCategories.map((categoryKey) => t(categoryKey));
}
